...
<head>
    ...
    <script type="text/javascript" src="consultar3.js"></script>
...
<body>
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
        ...
        <div class="app-main">
            ...
            <!-- TELA DE CONSULTA DE ALUGUEL-->
            <div class="app-main__outer">
                <div class="app-main__inner">
                    <div class="tab-content">
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                <h4>CONSULTAR ALUGUEL</h4>
                                <br>
                                <form method="POST" id="form-pesquisar-aluguel" action="">
                                    <label>Pesquisar:</label> 
                                    <br>
                                    <input id="pesquisa3" name="pesquisa3" class="form-control" placeholder="pesquise pelo id do cliente, do carro ou pela data de venda" required>
                                    <br>
