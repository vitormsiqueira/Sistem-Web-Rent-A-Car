...
<head>
    ...
    <script type="text/javascript" src="consultar2.js"></script>
</head>
                ...
                <div class="app-main__inner">
                    <div class="tab-content">
                        <div class="main-card mb-1 card">
                            <div class="card-body">
                                <h4>Pesquisar Clientes Cadastrados no sistema</h4>
                                <br>
                                <form method="POST" id="form-pesquisar-cliente" action="">
                                    <label>Pesquisar:</label> 
                                    <br>
                                    <input id="pesquisa2" name="pesquisa2" class="form-control" placeholder="digite o nome, cpf ou cnh" required>
                                    <br>
